...
define('HL_TWITTER_CRON_KEY', ''); // ?hl_twitter_cron=KEY, leave blank to disable
...
define('HL_TWITTER_OAUTH_CONSUMER_SECRET', 'tL9zLT0y8zbMFUUKOXRiXKc3DYtLckNgFOpvYDm0rc');
